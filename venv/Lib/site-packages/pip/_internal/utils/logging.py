...
def setup_logging(verbosity, no_color, user_log_file):
    ...
    handler_classes = {
        "stream": "pip._internal.misc.logging.ColorizedStreamHandler",
        "file": "pip._internal.misc.logging.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig({
        ...
        "filters": {
            "exclude_warnings": {
                "()": "pip._internal.misc.logging.MaxLevelFilter",
            ...
            "exclude_subprocess": {
                "()": "pip._internal.misc.logging.ExcludeLoggerFilter",
                "name": subprocess_logger.name,
            },
        },
        "formatters": {
