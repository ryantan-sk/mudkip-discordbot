...
class _shims(object):
    ...
    def __init__(self):
        # from .misc import _parse, get_package, STRING_TYPES
        from . import utils
        self.utils = utils
        ...
        self._locations = {
            ...
            "FAVORITE_HASH": ("misc.hashes.FAVORITE_HASH", "7.0.0", "9999"),
            "FormatControl": (
            ...
            "get_installed_distributions": (
                ("misc.misc.get_installed_distributions", "10", "9999"),
                ("misc.get_installed_distributions", "7", "9.0.3")
            ),
            "index_group": (
            ...
            "is_installable_dir": (
                ("misc.misc.is_installable_dir", "10.0.0", "9999"),
                ("misc.is_installable_dir", "7.0.0", "9.0.3")
            ),
